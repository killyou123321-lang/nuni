...
const MEASUREMENT_DATA = {
  universal: {
    keywords: ['כוס', 'כוסות', 'כף', 'כפות', 'כפית', 'כפיות', 'מ"ל', 'מיליליטר', 'מידות', 'מידה', 'כמות', 'מדידה', 'כמה מ"ל'],
...
• 1 כפית = 3 מ"ל`,
  ...
  pan: {
    keywords: ['תבנית', 'תבניות', 'קוטר', 'קוטרים', 'מקוטר', 'גודל תבנית', 'המרת תבנית', 'לשנות תבנית', 'להמיר תבנית', 'עגולה', 'תבנית עגול'],
...
💡 *לדוגמה: מתכון לתבנית 22 עם 3 ביצים → לתבנית 24 צריך 3.6 ביצים (≈ 4)*`,
  ...
  gelatin: {
    keywords: ['ג\'לטין', 'ג`לטין', 'ג׳לטין', 'עלה ג', 'עלי ג', 'עלי גלטין', 'עלי ג\'לטין'],
    answer: `🌿 **ג'לטין:**
...
🔄 **המרה:** 1 שקית ג'לטין אבקה = 3.5 עלי ג'לטין`,
  ...
  bakingPowder: {
    keywords: ['אבקת אפייה', 'אבקת אפיה', 'סודה לשתייה', 'סודה לשתיה', 'סודה'],
...
• 1 כפית = **3 גרם**`,
  ...
  yeast: {
    keywords: ['שמרים', 'שמר', 'קוביית שמרים', 'קובייה שמרים', 'שמרים יבשים', 'שמרים טריים', 'שמרים אינסטנט', 'שמרי'],
    answer: `🍞 **שמרים:**
...
• = 2 כפות שמרים יבשים (17 גרם)`,
  ...
  eggs: {
    keywords: ['ביצה', 'ביצים', 'ביצי', 'גודל ביצה', 'ביצה גדולה', 'ביצה קטנה', 'ביצה בינונית', 'מספר ביצה'],
...
• מס' 3 = **50 גרם** (קטנה)`,
  ...
  flour: {
    keywords: ['קמח', 'קמחים', 'קקאו', 'אבקת קקאו', 'קורנפלור', 'קמח תירס', 'קמח לבן', 'קמח מלא'],
...
• 1 כף = **10 גרם**`,
  ...
  whiteSugar: {
    keywords: ['סוכר לבן', 'סוכר רגיל', 'סוכר גבישי', 'סוכר'],
    answer: `🍬 **סוכר לבן:**
...
• 1 כף = **8 גרם**`,
  ...
  honey: {
    keywords: ['דבש', 'מולסה', 'סירופ תירס', 'סירופ מייפל', 'סירופ', 'מייפל', 'דבש תמרים', 'דבש רגיל'],
...
• 1 כפית = **7 גרם**`,
  ...
  butter: {
    keywords: ['חמאה', 'חמאות', 'חמאה מומסת', 'חמאה רכה', 'חמאה קרה', 'חמאה מלוחה'],
    answer: `🧈 **חמאה:**
...
• 1 כף = **15 גרם**`,
  ...
  nuts: {
    keywords: ['שקדים', 'שקד', 'אגוזים', 'אגוז', 'קוקוס', 'שוקולד צ\'יפס', 'צ\'יפס שוקולד', 'שיבולת שועל', 'שיבולות שועל', 'פירות יבשים', 'פרי יבש', 'צימוקים', 'צימוק', 'חמוציות', 'חמוצית'],
...
const CAPABILITIES_LIST = `📏 המרות מידות (כוס, כף, כפית ← מ"ל)
🍰 המרת גודלי תבניות
...
פשוט שאל/י אותי על מצרך או מידה ואני אענה מיד! 😊`;

const DEFAULT_MESSAGE = `אני אולי לא אוכל לעזור לך בשאלה הזו אבל מתמחה בטבלת מידות ומשקלות ויכולה לעזור לך עם:
...
export default function LilyChat({ onClose }) {
  const [messages, setMessages] = useState([
    {
      role: 'assistant',
      content: `שלום! אני לילי 👩🏽‍🍳 עוזרת המטבח שלך!\n\nאני כאן לעזור עם **המרות מידות ומשקלות** — שאל/י אותי על כל מצרך או מידה 😊`,
    },
  ]);
    ...
    <div style={{
      ...
      <div style={{
        ...
        <input
          ...
          placeholder="שאל/י על מידה או מצרך..."
          style={{
